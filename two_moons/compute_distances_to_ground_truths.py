...
STD_TRUTH_NAME = f'round_no_{1}_{100_000}_sim_std_theta_results'
TSTP_TRUTH_NAME_THETA = f'round_no_{1}_{100_000}_sim_twostep_theta_results'
TSTP_TRUTH_NAME_Z = f'round_no_{1}_{100_000}_sim_twostep_z_results'
...
for k, ground_truth_name in enumerate([STD_TRUTH_NAME, TSTP_TRUTH_NAME_THETA]):
    for m, inferer_type in enumerate(['std', 'twostep']):
        for method in ['c2st', 'wasserstein']:
            all_distances = []
